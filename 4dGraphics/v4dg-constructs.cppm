...
export class Buffer : public std::shared_ptr<const detail::BufferObject> {
public:
  Buffer() = delete;
...
export class Image : public std::shared_ptr<const detail::ImageObject> {
public:
