...
export module v4dg:device;

import :config;
import :dynamicStructureChain;
import :queue;
import :core;
...
namespace v4dg {
export using extension_storage =
    vk::ArrayWrapper1D<char, vk::MaxExtensionNameSize>;
